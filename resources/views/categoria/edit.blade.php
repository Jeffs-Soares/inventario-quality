...
<div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md mt-8">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Editar Categoria</h1>

        <form action="{{route('categoria.update', $categoria->id)}}" method="post" class="space-y-6">
            @csrf
            @method('put')

            <div>
                <label for="cat_descricao" class="block text-sm font-medium text-gray-700 mb-1">Nome da Categoria</label>
