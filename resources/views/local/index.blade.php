...
<table class="min-w-full divide-y divide-gray-200">
        ...
        @foreach($locais as $local)
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex">
                    <a href="{{ route('local.edit', $local->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-2">Editar</a>
 ...
 @if($errors->any())
        ...
        <div class="flex mt-4">
            ...
            <a class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm  me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 px-4 py-2" href="{{route('local.create')}}"> Store </a>
