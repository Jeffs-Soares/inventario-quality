...
<main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
                                ...
                                @foreach($locais as $local)
                                    <tr>
                                        ...
                                        <td class="px-3 py-4 whitespace-nowrap text-right text-sm font-medium flex items-center space-x-2">
                                            <a href="{{ route('local.edit', $local->id) }}" class="text-indigo-600 hover:text-indigo-900">Editar</a>
                ...
                <div class="flex flex-col sm:flex-row mt-4 gap-2">
                    <a class="w-full sm:w-auto text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" href="{{route('local.create')}}">
                        Store
                    </a>
