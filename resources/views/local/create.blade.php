...
<main class="flex-1 p-4 sm:p-6 lg:p-8">
   <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md mt-8">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Criar Local</h1>

        <form action="{{ route('local.store') }}" method="post" class="space-y-6">
            @csrf
            @method('post')

            <div>
                <label for="loc_descricao" class="block text-sm font-medium text-gray-700 mb-1">Descrição</label>
