...
<main class="flex-1 p-4 sm:p-6 lg:p-8">
                ...
                @foreach($registros as $registro)
                    <tr>
                        ...
                        <td class="px-3 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('registro.edit', $registro->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-2">Editar</a>
                            <form action="{{ route('registro.destroy', $registro->id) }}" method="post" class="inline-block">
                                @csrf
                                @method('delete')
    ...
    <div class="flex flex-col sm:flex-row mt-4 gap-2">
        <a class="w-full sm:w-auto text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" href="{{route('registro.create')}}">
            Store
        </a>
