...
<main class="flex-1 p-4 sm:p-6 lg:p-8">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Criar Registro</h1>

        <form action="{{route('registro.store')}}" method="post" class="space-y-6">
            @csrf
            @method('post')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <!-- Categoria -->
                <div>
                    <label for="categoria" class="block text-sm font-medium text-gray-700 mb-1">Selecione a categoria:</label>
                ...
                <!-- Item -->
                <div>
                    <label for="item" class="block text-sm font-medium text-gray-700 mb-1">Selecione o item:</label>
                ...
                <!-- Local -->
                <div>
                    <label for="local" class="block text-sm font-medium text-gray-700 mb-1">Selecione o local:</label>
